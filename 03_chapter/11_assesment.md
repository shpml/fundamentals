...
* Add some flare to the site by adding at least two colors!
  * Add some paint to the canvas! For now, we'll use the CSS property `color` to give some spice to the headers. Add the color *teal* to your h1 tag.
