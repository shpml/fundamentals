...
3) Save your `main.js` file, and open your `index.html` file in the browser to check if your `alert` is working. When it is working properly, you should see:
...
---
[Next up: Unit 10!](../10_chapter/intro.md)
