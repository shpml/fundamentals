...
**Elements** provide the basic structure for any website - they consist of **opening** and **closing tags** and the content in between these tags.

The tags tell the browser exactly what kind of content is being loaded and the basic structure of that content. For example, an opening heading tag (`<h1>`) and a closing heading tag (`<\h1>` ) tell the browser that it needs to render the text between these tags as a heading large heading. Watch the video below to learn more!
