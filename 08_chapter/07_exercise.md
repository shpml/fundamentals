...
Test your answer by replacing the `/* Your Expression */` comment in the JavaScript tab with `x = someValue;`, clicking the 'Run' button, writing your expression, and typing `enter` or `return`.
